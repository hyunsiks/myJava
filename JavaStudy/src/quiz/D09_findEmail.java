...
public class D09_findEmail {
	...
	public static void main(String[] args) {
		...
		System.out.println(Pattern.matches("[\\w\\S]+[@][\\w\\S]+[.][\\w\\S]+", "zeeny@chosun.com\\r\\n"));
		System.out.println(Pattern.matches("[\\w\\S]+[@][\\w\\S]+[.][\\w\\S]+", "kimnaver.com"));
		System.out.println(Pattern.matches("[\\w\\S]+[@][\\w\\S]+[.][\\w\\S]+", "kim@navercom"));
		
		
		
		String list = "조선일보	가정/육아	박은주	zeeny@chosun.com\r\n"
		...
		System.out.println("=============================================");
		Pattern kim = Pattern.compile("[\\\\w\\\\S]+[@][\\\\w\\\\S]+[.][\\\\w\\\\S]+");
		
		Matcher ckmail = Pattern.compile("[\\\\w\\\\S]+[@][\\\\w\\\\S]+[.][\\\\w\\\\S]+").matcher(list);
...
//				if(list2[i].matches("[\\w\\S]+[@][\\w\\S]+[.][\\w\\S]+")) {
//					System.out.println(list2[i]);
//					
//			
//				}
...
//		
//		System.out.println("camille@moneytoday.co.kr".matches("[\\w\\S]+[@][\\w\\S]+[.][\\w\\S]+"));
//		
//		Matcher checkMail = kim.matcher(list.split("\t"));	
//		
//		ArrayList<String> mailList = new ArrayList<>();
//		
//		String[] mailList1 = kim.split(list2);
//		System.out.println(Arrays.toString(mailList1));
	}
}
