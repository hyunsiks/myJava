		...
		/*
			# 변수 작명 규칙 (권장 사항)
			 ...
			 1. 두 단어 이상을 이어붙인 변수명을 사용할 때 _를 활용한다(snake_case)
			 	ex) apple_count, minsu_age 등등
			
			 2. 두 단어 이상을 이어붙인 변수명을 사용할 때 대문자를 활용한다(camelcase)
			 	ex)appleCount, minsuAge 등등
			 
			 3. 변수명 첫 글자는 소문자를 사용한다
			 
			 4. 클래스명 첫 글자는 대문자를 사용한다
			 
			 5. 프로그램 내에서 값이 변하지 않는 변수(상수)는 모두 대문자를 사용하다
			 	ex) APPLE_PRICE, APPLE_GRAM 등등
			
			 6. 변수에 들어있는 값을 추측할 수 있는 적절한 단어를 사용한다
