...
//                s += "!!!";
                ...
                //StringBuilder 안에 담겨있는 내용 찾기 (indexOf("문자"), lastIndexOf("문자")
                // ex) StringBuilder sb = new StringBuilder();  sb.indexOf("찾길원하는문자"); 
                ...
                for (int test = 0; test < test_freq; ++test) {
                        ...
                        for (int i = 0; i < text.length(); ++i) {
                                ...
                                System.out.println(reversed_text2.append(ch));                                
                        }
